...
export { default as imgTypeGable } from './Gable.png'
export { default as imgTypePullOut } from './Pull_Out.png'
export { default as imgTypePillow } from './Pillow.png'
export { default as imgTypeDisplays } from './Displays.png'
export { default as imgTypeOpenEnd } from './Open_end.png'
export { default as imgTypeTray } from './Tray.png'
export { default as imgTypeSleeve } from './Sleeve.png'
export { default as imgTypeFood } from './Food.png'
